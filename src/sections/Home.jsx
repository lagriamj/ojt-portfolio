  ...
  return (
    <div className="h-screen w-full flex flex-col items-center justify-center md:flex-row overflow-hidden">
      <motion.div
        ...
        className="w-full md:w-1/2 h-full flex items-center justify-center flex-col gap-4"
        ref={ref}
      >
        <Code
          style={{
        ...
        <div className="flex items-center justify-center gap-2 w-full">
          <span className="text-red-500 text-3xl font-semibold">
            <Code
              ...
              children="An Aspiring Software Developer"
            />
          </span>
        </div>

        <Code
          className="w-[90%] md:w-[60%] text-center"
          colorScheme="red"
          children="I am a graduating IT student from the University of Mindanao. I specialize in Back-End Development, and can also do Full-Stack Development."
        />
        <motion.a
          whileHover={{
          ...
          href={resume}
          download={resume}
          className="text-base bg-red-600 rounded-lg py-2 px-3 flex items-center justify-center gap-2 mt-4 border-none"
        >
          Download CV
          <FaDownload />
        </motion.a>
      ...
      <div className="hidden md:flex w-full md:w-1/2 h-full items-center justify-center flex-col">
        <motion.div
          ...
          transition={{ duration: 0.8 }}
          className="w-[80%] md:w-[60%] h-[50%] md:h-[60%] flex items-center justify-center bg-white rounded-full"
          ref={imgRef}
        >
          <img
            src={me}
